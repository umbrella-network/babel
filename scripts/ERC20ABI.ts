export default [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_maxAllowedTotalSupply', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool[]', name: 'statuses', type: 'bool[]' },
    ],
    name: 'LogSetRewardTokens',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'prevBridge', type: 'address' },
      { indexed: false, internalType: 'address', name: 'newBridge', type: 'address' },
    ],
    name: 'LogUpdateBridge',
    type: 'event',
  },
  {
    anonymous: false,
